...
// function set_custom_price_for_order_again_product( $cart ) {
...
//         // Check if the new_price is set
//         if ( isset( $cart_item['new_price'] ) ) {
            
//             // Set the new price
//             $cart_item['data']->set_price( (float) 103 );
//         }
//     }
// }
...
//     // Ensure 'find_closest_lower_quantity' function exists
//     if (!function_exists('find_closest_lower_quantity')) {
//         echo "<!-- 'find_closest_lower_quantity' function doesn't exist -->";
//         return;
//     }
...
//     // Iterate over each item in the cart
//     foreach ( $cart->get_cart() as $cart_item ) {
//         $custom_meta = get_all_meta_values($cart_item['custom_meta']);
//         $product_name = $cart_item['data']->get_name();
//         $quantity = $custom_meta['Quantity'];
//         $width = $custom_meta['Width'];
//         $height = $custom_meta['Height'];
//         $material = $cart_item['custom_meta']['Material'];
//         $custom_price = $cart_item['custom_meta']['Custom Price'];
//         // echo "custom_price ".$custom_price;
//         $calculatedVals = 0;
//         $widthClosestDiscount = intval(find_closest_lower_quantity(intval($quantity), $discounts[intval($width)]));
//         $heightClosestDiscount = intval(find_closest_lower_quantity(intval($quantity), $discounts[intval($height)]));
...
//         $cart_item['data']->set_price((float)$calculatedVals);
//     }
// }
